...
<%@ page import="com.example.SpringBootWEB1.model.JobPost" %>
<%@ page import="com.example.SpringBootWEB1.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">MHM Job Portal Web App</a>
